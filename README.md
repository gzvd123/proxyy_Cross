...
Một web app Flask gọn nhẹ giúp gộp nhiều file Excel "Inventory Update" thành một file duy nhất, tự động chuẩn hoá cột, bỏ qua file tạm và thêm logo UI đẹp mắt kèm bảng kiểm file chi tiết.

## Tính năng
- Giao diện web hiện đại, hỗ trợ kéo/thả hoặc chọn nhiều file Excel cùng lúc, cộng thêm bảng danh sách có thể xoá từng file.
